...
def add_salt_noise(img):
    ...
    # 中值滤波
    # Grey_sp_mf = scipy.ndimage.median_filter(Grey_sp, (2, 3))
    grey_gs_mf = scipy.ndimage.median_filter(grey_gs, (2, 1))
    ...
    plt.imsave("%s/image_after_reduce.jpg" % config.TEMP_IMAGE_PATH, grey_gs_mf)
...
if __name__ == '__main__':
    main('/Users/samho/Downloads/WechatIMG60.png')
